...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div id="wrapper">
        ...
        <nav id="sidebar" >
            <div id="main-menu" >
                <ul class="sidebar-nav" >
                    <li>
                        <a href="index.php" ><i class="fa fa-dashboard"></i><span class="sidebar-text">Dashboard</span></a>
                    </li>
                    <li>
        ...
        <div id="main-content" class="page-profil">
            ...
            <div class="row" >
                <div class="col-md-3 profil-sidebar" style="margin-top:41px;" >
                        <img src="assets/img/profil_page/me.jpg" class="img-responsive" alt="profil">
                        <div class="p-20">
                ...
                <div class="col-md-9 profil-content m-t-20" >
                        <h4 style="margin-top:60px;">TEAM</h4>
                    <div class="row profil-groups" style="margin-top:60px;">
                        <div class="col-md-6">
                            <div class="row border-gray">
                                <div class="col-xs-4">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/nature1.jpg" class="img-small-friend" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/nature2.jpg" class="img-small-friend" alt="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/nature3.jpg" class="img-small-friend" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/nature4.jpg" class="img-small-friend" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-8 p-0 profil-group">
                                    <h4 class="c-blue">Nature</h4>
                                    <p><strong>654 members</strong>
                                    </p>
                                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis pra quem é amistosis quis leo.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row border-gray">
                                <div class="col-xs-4">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/construction1.jpg" class="img-small-friend" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/construction2.jpg" class="img-small-friend" alt="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/construction3.jpg" class="img-small-friend" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 thumb">
                                            <img src="assets/img/profil_page/construction4.jpg" class="img-small-friend" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-8 p-0 profil-group">
